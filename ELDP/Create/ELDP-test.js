...
import { CREATE, CREATE_SAME_ELDP, CREATE_WITHOUT_SELESAI_DATE, CREATE_WITH_EMPTY_TYPE, CREATE_WITH_EMPTY_IMAGEURL, EMPTY_TITLE_AND_ACTIONURL, CREATE_ELDP_WITHOUT_DESCRIPTION,
         ...
         CREATE_ELDP_TAG_EMPTY_TAGLABEL } from './ELDP-data.js'
import { CreateELDP, Create_Same_ELDP, Create_Without_Name, Create_Without_Diterbitkan, Create_Without_Selesai, Create_With_Empty_Type, Create_With_Empty_ImageUrl,
         ...
         Create_ELDP_Type_Tag_Empty_tagId, Create_ELDP_Type_Tag_Empty_title, Create_ELDP_Type_Tag_TagLabel_Is_Empty } from './ELDP-step.js'
...
export default function(){ 
    ...
    describe('2. Mimin - Create Same ELDP', () => {
        const response = Create_Same_ELDP(CREATE_SAME_ELDP)
        console.log(response.body)
        console.log(response.status)
        //assertion
        expect(response).to.have.validJsonBody()
